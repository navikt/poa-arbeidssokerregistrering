...
const TEKSTER: Tekster<string> = {
    nb: {
        ...
        vilDuRegistreresIngress:
            'Hvis du trenger å registrere deg som arbeidssøker så må du kontakte NAV, som hjlper deg videre i prosessen. Si fra at du ikke får registrert deg på nav.no så kan vi gjøre endringer slik at du får registrert deg.',
